    ...
    var shuangji = function () {
        $("table td").dblclick(function () { //内容双击改变
            if (!$(this).is('.input')) {
                $(this).addClass('input').html('<input type="text" value="' + $(this).text() + '" />').find('input').focus().blur(function () {
                    $(this).parent().removeClass('input').html($(this).val() || '');
                    console.log(this.value);
    ...
    var xiala = function () {
        $('select').change(function () {
            if (this.value == 'table_1') {
                $('#table_1').removeClass("hide").siblings().addClass('hide')
            }
            if (this.value == 'table_2') {
                $('#table_2').removeClass("hide").siblings().addClass('hide')
            }
            if (this.value == 'table_3') {
                $('#table_3').removeClass("hide").siblings().addClass('hide')
            }
            if (this.value == 'table_4') {
                $('#table_4').removeClass("hide").siblings().addClass('hide')
            }
        })
    }
    xiala()
